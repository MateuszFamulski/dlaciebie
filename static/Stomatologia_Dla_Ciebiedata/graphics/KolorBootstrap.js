...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'Stomatologia_Dla_Ciebiedata/Stomatologia_Dla_Ciebie_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'Stomatologia_Dla_Ciebiedata/Stomatologia_Dla_Ciebie_messages_','.xml');
}
...
function addKolorArea(pPlugID)
{
	...
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"Stomatologia_Dla_Ciebiedata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"Stomatologia_Dla_Ciebiedata/graphics/KolorArea/KolorArea.min.js", [], true);
